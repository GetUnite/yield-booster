...
import { StEthVaultPool, IAlluoPool, ICurvePool, ICvxBooster, IERC20MetadataUpgradeable, IExchange, AlluoStEthEthVault, IWrappedEther } from "../typechain";
...
describe("Alluo Vault  StEth-Eth Tests", function () {
    ...
    let AlluoVault: AlluoStEthEthVault;
    ...
    before(async function () {
        ...
        console.log('\n', "||| Confirm that the _grantRoles(.., msg.sender) in AlluoStEthVault.sol has been uncommented to ensure tests are functioning correctly |||", '\n')
    ...
    before(async () => {
        ...
        const wrappedEther = await ethers.getContractAt("IWrappedEther", "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2") as IWrappedEther;
    ...
    beforeEach(async () => {
        ...
        let AlluoVaultFactory = await ethers.getContractFactory("AlluoStEthEthVault")
