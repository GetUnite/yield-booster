...
//     mapping(address => uint256) public whaleProtection;
//     uint256 public whaleProtectionFee;
...
//     /// @dev 
//     /// @param assets  Amount of vault assets to receive
...
//         if (whaleProtection[owner] + 7 days > block.timestamp) {
//             uint256 _whaleProtectionFee = assets * whaleProtectionFee / 10000;
//             assets -= _whaleProtectionFee;
//         }

//         IERC20MetadataUpgradeable(asset()).safeIncreaseAllowance(address(exchange), assets);
...
//     // Implement whaleProtectionFee against recent depositors to prevent stealing rewards.
//     function _withdraw(
//         address caller,
//         address receiver,
//         address owner,
...
//     {
//         if (from == address(0)) {
//             // If tokens are being minted with deposits,
//             whaleProtection[to] = block.timestamp;
//         }

//         if (to != address(0) && whaleProtection[from] + 7 days > block.timestamp) {
//             // If tokens are being transferred to another user and whaleProtection is still activated, 
//             // For now disable this:
//             revert("Whale Protection is enabled for the sender");
//         }
